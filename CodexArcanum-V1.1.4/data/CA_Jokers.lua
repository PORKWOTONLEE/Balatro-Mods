...
function CodexArcanum.INIT.CA_Jokers()
    ...
    local bottled_buffoon_def = {
        name = "瓶装小丑",
        text = {
            "每{C:attention}#1#{}次出牌后",
            "随机生成1张{C:alchemical}炼金{}牌",
            "{C:inactive}#2#"
        }
    }
    ...
    local chain_reaction_def = {
        ...
        text = {
            "复制每个盲注",
            "第一次使用的{C:alchemical}炼金牌{}",
            "并给予{C:dark_edition}负片{}效果"
        }
    }
    ...
    local shock_humor_def = {
        name = "触电感",
        text = {
            "当你弃掉1张{C:attention}黄金牌{}",
            "{C:attention}钢铁牌{}或{C:attention}石头牌{}时",
            "{C:green}#1#/#2#{}几率",
            "获得1张{C:alchemical}炼金{}牌"
        }
    }
    ...
    local breaking_bozo_def = {
        name = "强辐射",
        text = {
            "使用一张{C:alchemical}炼金牌{}后",
            "随机执行以下效果",
            "减少{C:attention}10%{}的盲注分数",
            "抽{C:attention}2{}张牌",
            "获得{C:attention}$5{}"
        }
    }
