function CodexArcanum.INIT.CA_Others()
    ...
    local v_cauldron_def = {
        name = "坩埚",
        text = {
            "部分{C:alchemical}炼金{}牌",
            "将会自带{C:dark_edition}负片"
        }
    }
    ...
    local philosopher_deck_def = {
        ...
        text = {
            "开局时即拥有",
            "{C:alchemical}炼金商人{}优惠券",
            "和一张{C:tarot,T:c_seeker}祈求者{}"
        },
    }
    ...
    local herbalist_deck_def = {
        ...
        text = {
            "开局时即拥有",
            "{C:tarot,T:v_mortar_and_pestle}研磨{}优惠券",
            "选择Boss盲注后",
            "获得一张免费的{C:alchemical}炼金牌{}"
        },
    }
