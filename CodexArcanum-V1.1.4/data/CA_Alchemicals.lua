...
function CodexArcanum.INIT.CA_Alchemicals()
    ...
    local alchemy_antimony_def = {
        name = "锑",
        text = {
            "随机{C:attention}复制{}一张小丑",
            "并给予复制牌{C:dark_edition}负片{}和{C:dark_edition}永恒{}",
            "效果持续一个盲注"
        }
    }
    ...
    local alchemy_uranium_def = {
        ...
        text = {
            ...
            " 至{C:attention}3{}张无增强随机手牌",
            "效果持续一个盲注"
        },
        unlock = {
            "在同一赛局中",
            "使用{C:attention}5{}张",
            "{E:1,C:alchemical}炼金牌{}"
        }
    }
