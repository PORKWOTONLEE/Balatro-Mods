...
G.localization.misc.dictionary["k_alchemical"] = "炼金牌"
G.localization.misc.dictionary["p_plus_alchemical"] = "+1 炼金牌"
G.localization.misc.dictionary["p_alchemy_plus_card"] = "+2 卡牌"
G.localization.misc.dictionary["p_alchemy_plus_money"] = "+5 金钱"
G.localization.misc.dictionary["p_alchemy_reduce_blind"] = "减少盲注"
...
function create_UIBox_your_collection()
    ...
    table.insert(retval.nodes[1].nodes[1].nodes[1].nodes[1].nodes[4].nodes[2].nodes, UIBox_button({
        button = 'your_collection_alchemicals', label = { "炼金牌" }, count = G.DISCOVER_TALLIES.alchemicals, minw = 4, id = 'your_collection_alchemicals', colour = G.C.SECONDARY_SET.Alchemy
    }))
    return retval
end
